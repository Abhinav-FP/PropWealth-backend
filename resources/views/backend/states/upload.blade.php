...
@section('title', 'Upload State Data')
    ...
    <div class="col-xl-6 col-lg-8 col-md-10">
      <div class="card shadow mb-4">
        <div class="card-header bg-white py-3">
          <h6 class="m-0 font-weight-bold text-primary">Upload State Data (Excel) 📊</h6>
        </div>
        <div class="card-body">
          @if (session('success'))
          ...
          <form id="uploadForm" action="{{ route('states.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
          ...
          <p class="text-center text-muted">
            ...
            <br> <code>code</code>, <code>name</code>
          </p>
        </div>
      </div>
    </div>
