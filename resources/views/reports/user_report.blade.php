...
<head>
  ...
  <style>
    ...
    * {
    ...
    .content-2 {
      left: 7%;
      top: 14%; /* Moved higher to give more space */
      width: 80%;
      max-height: calc(100% - 100mm); /* Better height calculation for PDF */
    ...
    .page-3-bg-base64, .page-4-bg-base64 {
    ...
    .chart-item img {
      ...
      max-width: 280px; /* Fixed max width instead of percentage */
      max-height: 160px; /* Fixed max height for consistency */
      width: auto;
      height: auto;
      object-fit: scale-down; /* Scale down if needed but preserve ratio */
    ...
    .chart-row {
      page-break-inside: avoid;
      margin-bottom: 12px; /* Further reduced for better spacing */
    }
    
    /* Ensure full-width charts don't overflow and maintain aspect ratio */
    .chart-item[style*="width: 100%"] {
      padding: 8px; /* Reduced padding for full-width items */
    }
    
    .chart-item[style*="width: 100%"] img {
      max-height: 120px; /* Smaller for full-width charts */
...
<body>
  ...
  <div class="page page-1-bg page-1-bg-base64">
    <div class="content-wrapper">
      ...
      <div class="content">
        <p>{{$suburb}} Property<br>Investment Outlook<br>{{ $year}}: Trends, Insights<br>and Growth Potential</p>
        <p class="date">{{$date}}</p>
      </div>
    </div>
    <div class="footer">
  ...
  <div class="page page-2-bg page-2-bg-base64">
    ...
    <div class="footer footer-2">
      <p class="footer-address">{{$suburb}} Property Investment Outlook 2025:<br>Trends, Insights & Growth Potential</p>
      <p><a href="https://propwealth.com.au/">www.propwealth.com.au</a></p>
    </div>
  </div>
          ...
          <div class="chart-container">
            ...
            <div class="chart-row">
              <div class="chart-item" style="width: 100%;">
                ...
                <img src="{{ $charts['housePriceChart'] }}" alt="House Price Chart" style="width: 80%; max-width: 500px;">
                @else
                <div class="chart-placeholder">Chart data unavailable</div>
                @endif
              </div>
        ...
        <div class="content-grap-right">
          <div class="chart-container">
            ...
            <div class="chart-row">
              <div class="chart-item">
                @if(isset($charts['housePriceSegments']) && !empty($charts['housePriceSegments']))
                <img src="{{ $charts['housePriceSegments'] }}" alt="" style="width: 60%;">
                @endif
              </div>
            </div>
